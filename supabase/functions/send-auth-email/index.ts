...
Tack för att du registrerade dig hos Kampen Sverige! Bekräfta din e-postadress via länken nedan:
${confirmationUrl}
      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
        <tr>
          <td style="border-radius: 8px; background: #fbbf24;" align="center">
            <a href="${confirmationUrl}" target="_blank" style="background: #fbbf24; color: #1a1a2e; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px; display: inline-block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Bekräfta e-postadress</a>
          </td>
        </tr>
      </table>
      <!--<![endif]-->
...
Du har begärt att återställa ditt lösenord hos Kampen Sverige. Använd länken nedan:
${confirmationUrl}
  ...
  <div style="max-width: 480px; margin: 0 auto; background: #1a1a2e; border-radius: 16px; padding: 32px; border: 1px solid #2a2a4a;">
    ...
    <div style="text-align: center; margin: 32px 0;">
      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
        <tr>
          <td style="border-radius: 8px; background: #fbbf24;" align="center">
            <a href="${confirmationUrl}" target="_blank" style="background: #fbbf24; color: #1a1a2e; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px; display: inline-block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Återställ lösenord</a>
          </td>
        </tr>
      </table>
      <!--<![endif]-->
